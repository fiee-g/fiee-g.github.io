...
const PUBLIC_CONTENT = {
  ...
  // 自我介绍（右侧内容区顶部）
  intro: "你好，我是高境。行政管理本科毕业，现攻读人力资源管理方向研究生，坐标北京。有文旅局办公室、字节跳动、学而思等多段 HR 实习经历，擅长活动组织策划与数据分析。",
      ...
      items: [
        {
          type: "timeline",
          content: [
            { time: "2025.09 — 2028.07", title: "中共北京市委党校 · 人力资源管理", desc: "硕士研究生" },
            ...
            { time: "2025.04 — 2025.08", title: "欣欣相融教育科技（好未来学而思）· HR 实习生", desc: "简历筛选、候选人沟通、面试全流程协调与招聘需求对接。" },
            { time: "2023.11 — 2025.06", title: "班级 · 副班长", desc: "协助班长管理班级、组织团建活动，获院优秀干部称号。" },
            { time: "2023.11 — 2023.12", title: "字节跳动 · HR 实习生", desc: "TikTok 国际电商招聘支持：简历筛选、候选人联系与面试安排。" },
            { time: "2023.07 — 2023.08", title: "乌鲁木齐市文旅局 · 实习生", desc: "办公室热线答疑、文件收发登记与公文写作，实现 0 投诉。" },
            { time: "2021.09 — 2025.07", title: "中国政法大学 · 行政管理", desc: "本科" },
          ],
        },
      ],
    },
